...
!     Fields from temperature
      call outpost(stat_ruavg(1,1,4),stat_ruavg(1,1,8),
     $     stat_ruavg(1,1,12),pr,stat_ruavg(1,1,12),'t01')

      call outpost(stat_ruavg(1,1,16),stat_ruavg(1,1,20),
     $     stat_ruavg(1,1,24),pr,stat_ruavg(1,1,24),'t02')

      call outpost(stat_ruavg(1,1,28),stat_ruavg(1,1,32),
     $     stat_ruavg(1,1,36),pr,stat_ruavg(1,1,36),'t03')

      call outpost(stat_ruavg(1,1,40),stat_ruavg(1,1,44),
     $     stat_ruavg(1,1,44),pr,stat_ruavg(1,1,44),'t04')
